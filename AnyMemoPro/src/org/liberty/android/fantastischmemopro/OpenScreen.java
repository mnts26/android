...
import org.liberty.android.fantastischmemopro.converter.*;
...
public class OpenScreen extends AMActivity implements OnItemClickListener, OnClickListener{
    ...
    private final static String TAG = "org.liberty.android.fantastischmemopro.OpenScreen";
    		...
    		if(requestCode == ACTIVITY_DB){
                ...
                Thread convertThread = new Thread(){
                    ...
                    public void run(){
                        ...
                        String filePath = tmpIntent.getStringExtra("org.liberty.android.fantastischmemopro.dbPath");
                        String fileName = tmpIntent.getStringExtra("org.liberty.android.fantastischmemopro.dbName");
                        try{
                ...
                Thread convertThread = new Thread(){
                    @Override
                    public void run(){
                        String dbPath = tmpIntent.getStringExtra("org.liberty.android.fantastischmemopro.dbPath");
                        String dbName = tmpIntent.getStringExtra("org.liberty.android.fantastischmemopro.dbName");
                        mAlert = new AlertDialog.Builder(mContext);
