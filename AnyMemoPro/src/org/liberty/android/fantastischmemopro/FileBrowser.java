...
public class FileBrowser extends AMActivity implements OnItemClickListener, OnItemLongClickListener{
    ...
    private final static String TAG = "org.liberty.android.fantastischmemopro.FileBrowser";
			...
			if(clickedFile != null){
				try{
					if(clickedFile.isDirectory()){
						...
						resultIntent.putExtra("org.liberty.android.fantastischmemopro.dbName", clickedFile.getName());
						resultIntent.putExtra("org.liberty.android.fantastischmemopro.dbPath", clickedFile.getParent());
