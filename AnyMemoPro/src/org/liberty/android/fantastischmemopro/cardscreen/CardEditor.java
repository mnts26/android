...
public class CardEditor extends Activity implements View.OnClickListener{
    private final static String TAG = "org.liberty.android.fantastischmemopro.CardEditor";
    	...
    	switch(requestCode){
    	    case ACTIVITY_IMAGE_FILE:
                if(resultCode == Activity.RESULT_OK){
                    View focusView = getCurrentFocus();
                    if(focusView == questionEdit || focusView ==answerEdit || focusView == categoryEdit){
                        name = data.getStringExtra("org.liberty.android.fantastischmemopro.dbName");
                        path = data.getStringExtra("org.liberty.android.fantastischmemopro.dbPath");
