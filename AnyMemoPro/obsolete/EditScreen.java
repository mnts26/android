...
public class EditScreen extends MemoScreenBase implements OnGesturePerformedListener, View.OnClickListener{
    ...
    private static final String TAG = "org.liberty.android.fantastischmemopro.EditScreen";
    ...
    private void doMerge(final Intent data){
        ...
        new Thread(){
            @Override
            public void run(){
                final String name = data.getStringExtra("org.liberty.android.fantastischmemopro.dbName");
                final String path = data.getStringExtra("org.liberty.android.fantastischmemopro.dbPath");
                try{
